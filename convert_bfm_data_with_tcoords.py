...
def transferBFM09():
	...
	non_neck_v3 = loadmat('BFM/model_info.mat')
	...
	tcoords = np.load('BFM/wilduv_tcoord.pkl', allow_pickle=True)
	tcoords = tcoords[index_exp, :]
	tcoords = np.reshape(tcoords, [-1, 2])
	...
	# save our face model
	savemat('BFM/BFM_model_front.mat',{'meanshape':meanshape,'meantex':meantex,'idBase':idBase,'exBase':exBase,'texBase':texBase,'tri':tri, 'tcoords':tcoords, 'point_buf':point_buf,'tri_mask2':tri_mask2\
