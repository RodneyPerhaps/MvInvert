...
class ReconModel(nn.Module):
    ...
    def render_mesh_from_different_poses(self, vis_hat, shape_dict, vtex, batch_num, img_tensor, face_color):
        imgs_dict = {}
        shape2D_dict = {}
        tri = self.tri.long() - 1
        ...
        samples_T['origin'], samples_W['origin'] = self.Sample_image(shape_dict['front'], ori_shape2D, ori_shape2D, ori_visibility, img_tensor, fbuffer, 21.5, face_color)
    ...
    def Sample_image(self, face_shape, shape2D, shape2D_aligned, visibility, img, fbuffer, boundarydistT, face_color):
    ...
    def forward(self, coeff, img_tensor=None):
        ...
        if img_tensor is not None:
            ...
            return_tex, return_tex_color, imgs, tex_diff_poses, ginv = self.render_mesh_from_different_poses(vis_hat, shape_dict, vtex0, self.batch_size, img_tensor, face_color)
